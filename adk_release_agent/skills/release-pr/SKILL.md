...
- Use `get_pr_details` and `get_pr_comments` before summarizing a PR — read
  both, then summarize the CHG/RMG tickets and RLFT/RFTL control status
  yourself from what they returned.
